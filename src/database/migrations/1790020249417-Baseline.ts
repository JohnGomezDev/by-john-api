...
export class Baseline1790020249417 implements MigrationInterface {
  name = 'Baseline1790020249417';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "posts_chunks" ("id" uuid NOT NULL, "post_id" uuid NOT NULL, "chunk_index" integer NOT NULL, "content" text NOT NULL, "embedding" vector(1024) NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_a4afb00240c0a15cfd21e899404" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX "idx_chunks_post_chunk_index" ON "posts_chunks"  ("post_id", "chunk_index") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "songs" ("id" SERIAL NOT NULL, "track_id" character varying(255) NOT NULL, "track_name" character varying(255) NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_e504ce8ad2e291d3a1d8f1ea2f4" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "posts_chunks" ADD CONSTRAINT "FK_4087260027a2104e3d2de071176" FOREIGN KEY ("post_id") REFERENCES "posts"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "posts_chunks" DROP CONSTRAINT "FK_4087260027a2104e3d2de071176"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."idx_chunks_post_chunk_index"`,
    );
