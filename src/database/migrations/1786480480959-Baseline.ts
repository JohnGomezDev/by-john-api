...
export class Baseline1786480480959 implements MigrationInterface {
    name = 'Baseline1786480480959'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`INSERT INTO "typeorm_metadata"("database", "schema", "table", "type", "name", "value") VALUES ($1, $2, $3, $4, $5, $6)`, ["portfolio_db","public","posts","GENERATED_COLUMN","search_vector","to_tsvector('spanish', coalesce(title, '') || ' ' || coalesce(content, ''))"]);
        await queryRunner.query(`CREATE TABLE "posts" ("id" uuid NOT NULL, "title" character varying(255) NOT NULL, "slug" character varying(255) NOT NULL, "content" text NOT NULL, "excerpt" character varying(160) NOT NULL, "search_vector" tsvector GENERATED ALWAYS AS (to_tsvector('spanish', coalesce(title, '') || ' ' || coalesce(content, ''))) STORED NOT NULL, "published" boolean NOT NULL DEFAULT false, "published_at" TIMESTAMP, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "admin_id" uuid NOT NULL, "category_id" uuid NOT NULL, CONSTRAINT "UQ_54ddf9075260407dcfdd7248577" UNIQUE ("slug"), CONSTRAINT "PK_2829ac61eff60fcec60d7274b9e" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "idx_post_search" ON "posts"  ("search_vector") `);
        ...
        await queryRunner.query(`CREATE TABLE "admin_users" ("id" uuid NOT NULL, "username" character varying(255) NOT NULL, "email" character varying(255) NOT NULL, "password_hash" character varying(255) NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_2873882c38e8c07d98cb64f962d" UNIQUE ("username"), CONSTRAINT "UQ_dcd0c8a4b10af9c986e510b9ecc" UNIQUE ("email"), CONSTRAINT "PK_06744d221bb6145dc61e5dc441d" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "spotify_tracks" ("id" SERIAL NOT NULL, "track_id" character varying(255) NOT NULL, "track_name" character varying(255) NOT NULL, "artists" jsonb NOT NULL, "album_id" character varying(255) NOT NULL, "album_name" character varying(255) NOT NULL, "album_cover_url" character varying(2048) NOT NULL, "spotify_url" character varying(2048) NOT NULL, "preview_url" character varying(2048), "duration_ms" integer NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_e3cb9d9a082fe08bc68c2ddc34c" PRIMARY KEY ("id"))`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TABLE "spotify_tracks"`);
        ...
        await queryRunner.query(`DELETE FROM "typeorm_metadata" WHERE "type" = $1 AND "name" = $2 AND "database" = $3 AND "schema" = $4 AND "table" = $5`, ["GENERATED_COLUMN","search_vector","portfolio_db","public","posts"]);
